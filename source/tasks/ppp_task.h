/******************************************************************************
* File Name:   ppp_task.h
*
* Description: This file is the public interface of ppp_task.c
*
...
#ifndef SOURCE_PPP_TASK_H_
#define SOURCE_PPP_TASK_H_
...
#define PPP_TASK_STACK_SIZE  (5 * 1024)
#define PPP_TASK_PRIORITY    CY_RTOS_PRIORITY_LOW
#define PPP_TASK_NAME        "PPP task"

#if (FEATURE_PPP == ENABLE_FEATURE)
extern cy_thread_t g_ppp_task_handle;
#endif
