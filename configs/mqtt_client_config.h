...
#ifndef SOURCE_MQTT_CLIENT_CONFIG_H_
#define SOURCE_MQTT_CLIENT_CONFIG_H_
...
extern cy_mqtt_connect_info_t g_mqtt_connection_info;

#ifdef __cplusplus
}
#endif

#endif /* SOURCE_MQTT_CLIENT_CONFIG_H_ */
